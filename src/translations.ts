export const translations = {
  ar: {
    ...
    goalDescription: "🇦🇹 في لحظة تاريخية لن تُنسى، سجل ناصر منسي هدفاً خالداً من بعده لن تكون منسيا يا منسي في الدقيقة 76 والثانية 42 من المباراة. هذا الهدف الذي جاء في توقيت حاسم من المباراة، أشعل حماس الجماهير الزملكاوية."
  },
  en: {
